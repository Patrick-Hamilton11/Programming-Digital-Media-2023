...
//creating an game object using JSON
let game = { score: 0, maxScore: 0, maxTime: 10, elapsedTime: 0, totalSprites: 15, state: GameState.Start }
...
function reset(){
  ...
  for(let i=0; i < game.totalSprites; i++) {
    animations[i] = new WalkingAnimation(random(spriteSheets),80,80,random(50,width-50),random(50,height-50),9,random(0.5,1),6, random(0,1));
  }
...
function draw() {
  switch(game.state){
    ...
    case GameState.GameOver: 
      ...
      text("Press any key to play again", 200, 360 );
      break;
